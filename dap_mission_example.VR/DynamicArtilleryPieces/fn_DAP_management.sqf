...
// Fire-mission general settings:
	...
	DAP_fmCycle_coolDown  = 40;             // In seconds, a base for another calc use to create a assymetric delay for the each cycle of a fire-mission / Default: 40;
	...
	DAP_fmCaliber_timeRearmHeavy       = 40;  // in seconds, reload time for MRL heavy caliber. Minimal 60 / Default 120;
	DAP_fmCaliber_timeRearmSuperH      = 40;  // in seconds, reload time for MRL super heavy caliber. Minimal 120 / Default 240;
	
// Server:
	DAP_fmVirtualETA        = selectRandom [25, 35, 45];  // In secs, simulates the Estimated Time to Arrival from (if) virtual rounds. Default: selectRandom [25, 35, 45];
	...
	DAP_preventStartLowAmmo = false;   // (WIP) true = DAP will prevent pieces to start with no mags (mods are bugged and it'll help) / false = Editor decides / Default: false;
	DAP_preventUnlocked     = false;   // true = DAP will lock for players all artillery-pieces where it's possible / false = Editor decides / Default: true;
	DAP_preventMoving       = true;  // true = DAP will prevent piece self-propelled to change its position for any reason / false = Arma decides / Default: true;
	DAP_fireMissionBreath   = 5;     // In seconds, time you give to the server reads each fire-mission. Never lower than 2. Default: 10;
...
// Codenames for fire-missions (fill free to custom):
	DAP_firemissions_codenames = [
		// Blufor codenames
		["NEWYORK","LONDON","TOKYO","PARIS","CAEN","VALENCIA","HONGKONG","SINGAPORE","LOSANGELES","BEIJING","SHANGHAI","DUBAI","MUMBAI","SEOUL","SYDNEY","SANFRANCISCO","MOSCOW","BERLIN","MADRID","TORONTO","CHICAGO","ISTANBUL","BANGKOK","KUALA LUMPUR","BUENOSAIRES","SAOPAULO","MEXICOCITY","JOHANNESBURG","ROME","MELBOURNE","JAKARTA","CAIRO","DELHI","SHENZHEN","GUANGZHOU","VIENNA","ZURICH","MUNICH","AMSTERDAM","GENEVA","HOUSTON","ABUDHABI","WASHINGTON","BOSTON","MIAMI","BARCELONA","STOCKHOLM","COPENHAGEN","DUBLIN","OSLO","BRUSSELS","FRANKFURT","PRAGUE","BRNO","WARSAW","BUDAPEST","HELSINKI","LISBON","ATHENS","TELAVIV","DOHA","RIYADH","MANILA","CHENNAI","BANGALORE","CAPETOWN","DURBAN","LAGOS","CASABLANCA","ADDISABABA","NAIROBI","HOCHIMINHCITY","HANOI","TAIPEI","KOLKATA","KARACHI","TEHRAN","BAGHDAD","DAMASCUS","RABAT","ALGIERS","ANKARA","BUCHAREST","SOFIA","BELGRADE","LIMA","SANTIAGO","BOGOTA","RIO","MONTEVIDEO","ASUNCION","QUITO","CARACAS","HAVANA","PANAMACITY","SANJOSE","KINGSTON","LAPAZ","SANTACRUZ","SANSALVADOR","GUATEMALACITY","TEGUCIGALPA","PORTOALEGRE","CHARQUEADAS","TBILISI","MILAN","SANREMO","BASTOGNE","MEDELLIN"],
		// Opfor codenames
		["NEWYORK","LONDON","TOKYO","PARIS","CAEN","VALENCIA","HONGKONG","SINGAPORE","LOSANGELES","BEIJING","SHANGHAI","DUBAI","MUMBAI","SEOUL","SYDNEY","SANFRANCISCO","MOSCOW","BERLIN","MADRID","TORONTO","CHICAGO","ISTANBUL","BANGKOK","KUALA LUMPUR","BUENOSAIRES","SAOPAULO","MEXICOCITY","JOHANNESBURG","ROME","MELBOURNE","JAKARTA","CAIRO","DELHI","SHENZHEN","GUANGZHOU","VIENNA","ZURICH","MUNICH","AMSTERDAM","GENEVA","HOUSTON","ABUDHABI","WASHINGTON","BOSTON","MIAMI","BARCELONA","STOCKHOLM","COPENHAGEN","DUBLIN","OSLO","BRUSSELS","FRANKFURT","PRAGUE","BRNO","WARSAW","BUDAPEST","HELSINKI","LISBON","ATHENS","TELAVIV","DOHA","RIYADH","MANILA","CHENNAI","BANGALORE","CAPETOWN","DURBAN","LAGOS","CASABLANCA","ADDISABABA","NAIROBI","HOCHIMINHCITY","HANOI","TAIPEI","KOLKATA","KARACHI","TEHRAN","BAGHDAD","DAMASCUS","RABAT","ALGIERS","ANKARA","BUCHAREST","SOFIA","BELGRADE","LIMA","SANTIAGO","BOGOTA","RIO","MONTEVIDEO","ASUNCION","QUITO","CARACAS","HAVANA","PANAMACITY","SANJOSE","KINGSTON","LAPAZ","SANTACRUZ","SANSALVADOR","GUATEMALACITY","TEGUCIGALPA","PORTOALEGRE","CHARQUEADAS","TBILISI","MILAN","SANREMO","BASTOGNE","MEDELLIN"],
