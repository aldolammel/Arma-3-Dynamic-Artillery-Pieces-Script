...
// Fire-mission general settings:
	...
	DAP_fmCaliber_timeRearmSuperH      = 50;  // in seconds, reload time for MRL super heavy caliber. Minimal 120 / Default 240;
...
// Server:
	...
	DAP_preventStartLowAmmo = false;   // true = DAP will prevent pieces to start dry or with low levels of ammunition / false = Editor decides / Default: true;
