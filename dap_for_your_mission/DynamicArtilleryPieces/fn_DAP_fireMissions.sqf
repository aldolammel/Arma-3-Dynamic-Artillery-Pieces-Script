...
[] spawn {
    ...
    private ["_caliber_ANY","_caliber_LIGHT","_caliber_MEDIUM","_caliber_HEAVY","_caliber_SUPERHEAVY","_ammo_HE","_ammo_CLUSTER","_ammo_CLUSTER_MINE_AP","_ammo_CLUSTER_MINE_AT","_ammo_GUIDED","_ammo_GUIDED_LASER","_ammo_SMOKE","_ammo_FLARE"];
    _caliber_ANY="ANY";_caliber_LIGHT="LIGHT";_caliber_MEDIUM="MEDIUM";_caliber_HEAVY="HEAVY";_caliber_SUPERHEAVY="SUPERHEAVY";_ammo_HE="HE";_ammo_CLUSTER="CLUSTER";_ammo_CLUSTER_MINE_AP="CLUSTER_MINE_AP";_ammo_CLUSTER_MINE_AT="CLUSTER_MINE_AT";_ammo_GUIDED="GUIDED";_ammo_GUIDED_LASER="GUIDED_LASER";_ammo_SMOKE="SMOKE";_ammo_FLARE="FLARE";


    // ..............................................................................................................................

    // ARTILLERY PIECES POWER OPTIONS:
    ...
    if ( DAP_BLU_isOn && count DAP_targetMrksBLU > 0 ) then {
        ...
        // Define each fire-mission should be available for this side.

            // [ BLUFOR [ Target markers, "Sector" ], [ Number of pieces, Pieces Caliber, Ammo type, Rounds per piece, Repetition cycle ], [ Triggers ] ]
    ...
    if ( DAP_OPF_isOn && count DAP_targetMrksOPF > 0 ) then {
        ...
        // Define each fire-mission should be available for this side.
            ...
            // [ OPFOR [ Target markers, "Sector" ], [ Number of pieces, Pieces Caliber, Ammo type, Rounds per piece, Repetition cycle ], [ Triggers ] ]
    ...
    if ( DAP_IND_isOn && count DAP_targetMrksIND > 0 ) then {
        ...
        // Define each fire-mission should be available for this side.
            ...
            // [ INDEPENDENT [ Target markers, "Sector" ], [ Number of pieces, Pieces Caliber, Ammo type, Rounds per piece, Repetition cycle ], [ Triggers ] ]
