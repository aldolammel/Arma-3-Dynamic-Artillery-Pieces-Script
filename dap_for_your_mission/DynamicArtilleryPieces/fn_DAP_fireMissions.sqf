...
[] spawn {
    ...
    if ( DAP_BLU_isOn && count DAP_targetMrksBLU > 0 ) then {
        ...
        // Define each fire-mission should be available for this side. You can add or remove fire-mission rows as you wish.
            ...
            [BLUFOR, [DAP_targetMrksBLU, "A"], [true, 1, _caliber_SUPERHEAVY, _ammo_HE, 12, 2], [your_trigger_1, your_trigger_2]] call THY_fnc_DAP_add_firemission;
            [BLUFOR, [DAP_targetMrksBLU, "A"], [true, 2, _caliber_SUPERHEAVY, _ammo_HE, 3, 1], [your_trigger_3]] call THY_fnc_DAP_add_firemission;

            [BLUFOR, [DAP_targetMrksBLU, "B"], [true, 2, _caliber_MEDIUM, _ammo_CLUSTER, 6, 2], [target_you_wanna_kil_1]] call THY_fnc_DAP_add_firemission;
            [BLUFOR, [DAP_targetMrksBLU, "B"], [true, 1, _caliber_MEDIUM, _ammo_CLUSTER, 3, 1], [target_you_wanna_kil_2]] call THY_fnc_DAP_add_firemission;
    ...
    if ( DAP_OPF_isOn && count DAP_targetMrksOPF > 0 ) then {
        ...
        // Define each fire-mission should be available for this side. You can add or remove fire-mission rows as you wish.
            ...
            [OPFOR, [DAP_targetMrksOPF, "A"], [true, 5, _caliber_LIGHT, _ammo_HE, 5, 2], [trg_example_opf_1, 2]] call THY_fnc_DAP_add_firemission;
            [OPFOR, [DAP_targetMrksOPF, "A"], [true, 5, _caliber_MEDIUM, _ammo_HE, 12, 2], [trg_example_opf_2]] call THY_fnc_DAP_add_firemission;
    ...
    if ( DAP_IND_isOn && count DAP_targetMrksIND > 0 ) then {
        ...
        // Define each fire-mission should be available for this side. You can add or remove fire-mission rows as you wish.
            ...
            [INDEPENDENT, [DAP_targetMrksIND, "A"], [true, 10, _caliber_LIGHT, _ammo_HE, 5, 3], [trg_example_ind_1]] call THY_fnc_DAP_add_firemission;
            [INDEPENDENT, [DAP_targetMrksIND, "A"], [true, 2, _caliber_MEDIUM, _ammo_HE, 12, 2], [trg_example_ind_2, trg_example_ind_3]] call THY_fnc_DAP_add_firemission;
